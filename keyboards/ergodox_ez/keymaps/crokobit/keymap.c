 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |CapsLock|   Q  |   W  |   E  |   R  |   T  |      |           |      |   Y  |   U  |   I  |   O  |   P  |  DEL   |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Cmd/Esc|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |  ;   |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LEFT,KC_DOWN,KC_LBRC,KC_RBRC,KC_RCTRL,

                                                    KC_LALT,   KC_HOME,
                                                               KC_END,
                                               KC_SPC,MT(MOD_RCTL, KC_BSPC) ,KC_TRNS,
        // right hand
             ...
             KC_RGUI, KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,   KC_RSFT,
                                  KC_LCTRL,KC_PIPE,KC_RGUI,KC_UP,KC_RIGHT,

             KC_PGUP,        KC_RALT,
             KC_PGDN,
             KC_TRNS,MT(MOD_RCTL, KC_TAB), KC_ENT
    ),
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_PGUP,KC_DLR, KC_LPRN,KC_RPRN,KC_GRV,
       KC_TRNS,KC_PGDN,KC_CIRC,KC_LBRC,KC_RBRC,KC_TILD,KC_TRNS,
